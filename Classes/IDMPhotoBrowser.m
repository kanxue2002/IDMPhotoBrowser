...
@interface IDMPhotoBrowser () {
    ...
    // Toolbar
    UIToolbar *_toolbar;
    UIBarButtonItem *_previousButton, *_nextButton, *_actionButton, *_saveButton;
...
- (void)viewDidLoad {
    ...
    _saveButton = [[UIBarButtonItem alloc] initWithCustomView:[self customToolbarButtonTitle:@"保存" action:@selector(saveButtonPressed:)]];
